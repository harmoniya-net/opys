/**
 * `@torba/runtime` — install + launch executor. Behaviors are backed by the
 * Rust `torba-runtime` crate (via napi-rs); the TS surface wraps the
...
import * as napi from '@torba/runtime-binding';
