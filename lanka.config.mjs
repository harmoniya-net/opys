// @lanka-preserve
import { defineConfig, userDataDir, artifactScanner } from '@lanka/dev';
import { forge, authliberty, curseforge, bifrost } from '@lanka/minecraft';
  ...
  plugins: [
    ...
    curseforge({
      ...
      files: [
        ...
        5281700, // Bookshelf-Forge-1.20.1-20.2.13.jar
