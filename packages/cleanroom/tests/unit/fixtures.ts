...
// longer intercept it. The GitHub release listing and the installer
// zip still go through `fetchWithRetry` and keep their stub — only the Mojang
// half needs a real socket.
// ──────────────────────────────────────────────────────────────────────────
