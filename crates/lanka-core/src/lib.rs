//! `@lanka/core` — manifest data model, shorthand, Val/Valset, glob,
//! interpolation. Reference implementation of the frozen `lanka.json` wire
//! format. Mirrors the TS package one-to-one.
//!
//! Depends on `lanka-mojang-rules` for the rule format/evaluator.
